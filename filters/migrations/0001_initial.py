    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filtercar', to='Shop.Car', verbose_name='Car')),
            ],
            options={
                'verbose_name': 'Filter Car',
                'verbose_name_plural': 'Filters Car',
            },
        ),
        migrations.CreateModel(
            name='FilterCategory',
