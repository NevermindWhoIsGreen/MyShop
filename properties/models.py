...
class CategoryProperty(OrderingBaseModel):
    ...
    category = models.ForeignKey('Shop.Category', on_delete=models.CASCADE, related_name='categories_property',
...
class ProductProperty( OrderingBaseModel):
    category_property = models.ForeignKey(CategoryProperty, on_delete=models.CASCADE,
                                          related_name='category_property', verbose_name =_('Propery'))
    value = models.CharField(_("Value"), default="", max_length=250)
    product = models.ForeignKey('Shop.Product', on_delete=models.CASCADE,
                                related_name='properties_product', verbose_name =_('Product'))
